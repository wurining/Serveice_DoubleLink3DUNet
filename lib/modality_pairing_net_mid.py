...
def get_main_net(IMG_HEIGHT=128, IMG_WIDTH=128, IMG_DEPTH=128, IMG_CHANNELS=4, num_classes=4, data_type=tf.float32):
    ...
    # Path-B input
    path_b = inputs[::, ::, ::, ::, 0:2:1]
    layer_1_output_channel = 16
    layer_2_output_channel = 32
    layer_3_output_channel = 64
    layer_4_output_channel = 128
    layer_5_output_channel = 256
    ...
    feature_a = Conv3DTranspose(layer_3_output_channel, kernel_size=(2, 2, 2), strides=(2, 2, 2), padding='same')(c6a)
    feature_b = Conv3DTranspose(layer_3_output_channel, kernel_size=(2, 2, 2), strides=(2, 2, 2), padding='same')(c6b)
    del c6a
    del c6b
    ...
    feature_a = Conv3DTranspose(layer_2_output_channel, kernel_size=(2, 2, 2), strides=(2, 2, 2), padding='same')(c7a)
    feature_b = Conv3DTranspose(layer_2_output_channel, kernel_size=(2, 2, 2), strides=(2, 2, 2), padding='same')(c7b)
    del c7a
    del c7b
    ...
    feature_a = Conv3DTranspose(layer_1_output_channel, kernel_size=(2, 2, 2), strides=(2, 2, 2), padding='same')(c8a)
    feature_b = Conv3DTranspose(layer_1_output_channel, kernel_size=(2, 2, 2), strides=(2, 2, 2), padding='same')(c8b)
    del c8a
    del c8b
